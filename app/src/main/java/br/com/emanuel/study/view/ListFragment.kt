package br.com.emanuel.study.view
...
import br.com.emanuel.study.R
import br.com.emanuel.study.model.Animal
import br.com.emanuel.study.viewmodel.ListViewModel
...
class ListFragment : Fragment() {
    ...
    private val erroLiveDataObserver = Observer<Boolean> {isError ->
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.loadError.observe(this, erroLiveDataObserver)
        viewModel.refresh()
